...
//
// Board bring-up for the ESP32-2432S028Rv3 ("Cheap Yellow Display").
//
// This board has no I2C-attached peripherals on the touch path (the XPT2046
...
// No I2C touch on this board; the GT911-style shared bus does not exist here.
